---
date: 2026-06-18
title: 'Daily Update – Jun 18, 2026'
...
---
'All Black National Convention: Build Wealth &amp; Community; Inside Toy Story 5: A Tech Talk with VFX Supervisor Thomas Jordan; Indian Comedian Russell Peters Steals Gina Yashere’s Jokes | One54 Africa Podcast; Only Rich Celebrities Can Lead Black America? | OTSOG Live Clip ; Sis CHECKS Asian Claims That Black Folks Are Plotting To Torch Asian-Owned Businesses'
...
videos_joined <- videos_tbl |> 
    select(publishedAt,title, description, embeds, 
           channelId, category) |> 
    filter(publishedAt >= lubridate::ymd('2026-06-18')-1)
